package com.migo.android.tests.AL5;
...
public class Migo_AL5 extends UserBaseTest {

	Logger logger = Logger.getLogger(Migo_AL5.class.getName());

	@BeforeClass
	@Description(value = "Returning user launches app while connected to the Migo Hotspot")
	@Parameters({ "device" })
	@Author(name = "Shah Nawaz")
	public void AL5_Precondition(String device) throws InterruptedException, IOException {
	...
	@Test
	@Description(value = "User can Open his/her Migo App for the [x] times while connected to the Migo Hotspot")
	@Parameters({ "device" })
	@Author(name = "Shah Nawaz")
	public void AL5_001() throws InterruptedException {
