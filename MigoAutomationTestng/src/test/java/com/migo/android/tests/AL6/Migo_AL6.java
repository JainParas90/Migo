package com.migo.android.tests.AL6;
...
public class Migo_AL6 extends UserBaseTest {

	Logger logger = Logger.getLogger(Migo_AL6.class.getName());

	@BeforeClass
	@Description(value = "Returning user launches app while connected to an Internet connection")
	@Parameters({ "device" })
	@Author(name = "Shah Nawaz")
	public void AL6_Precondition(String device) throws InterruptedException, IOException {
	...
	@Test
	@Description(value = "User can Open his/her Migo App for the [x] times while connected to an Internet connection")
	@Parameters({ "device" })
	@Author(name = "Shah Nawaz")
	public void AL6_001() throws InterruptedException {
