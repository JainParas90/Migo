package com.migo.android.tests.AL2;
...
public class Migo_AL2 extends UserBaseTest {

	Logger logger = Logger.getLogger(Migo_AL2.class.getName());

	@BeforeClass
	@Description(value = "New user launches the app for the first time while connected to the Migo Hotspot")
	@Parameters({ "device" })
	...
	@Parameters({ "device" })
	@Author(name = "Shah Nawaz")
	public void AL2_001(String device) throws InterruptedException {
	...
	@Parameters({"device"})
	@Author(name = "Shah Nawaz")
	public void AL2_002() throws InterruptedException {
	...
	@Parameters({ "device" })
	@Author(name = "Shah Nawaz")
	public void AL2_003() throws InterruptedException {
