package com.migo.android.tests.MF2;
...
import com.migo.android.tests.MF1.Migo_MF1;
...
public class Migo_MF2 extends UserBaseTest {
	...
	@Test
	@Description(value = "MF2 User launches app online, then browses moretab")
	@Parameters({ "device" })
	@Author(name = "Paras Jain")
	public void MF2_001(String device) throws InterruptedException {
