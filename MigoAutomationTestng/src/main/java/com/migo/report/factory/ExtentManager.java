package com.migo.report.factory;
...
public class ExtentManager {
	...
	private static ExtentHtmlReporter getHtmlReporter() {
		...
		htmlReporter.config().setDocumentTitle("Migo Execution Report");
		htmlReporter.config().setReportName("Migo Automation");
